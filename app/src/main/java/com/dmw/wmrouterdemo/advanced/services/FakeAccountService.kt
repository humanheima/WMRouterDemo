package com.dmw.wmrouterdemo.advanced.services
...
@RouterService(
    ...
    key = [FAKE_ACCOUNT_SERVICE],
    singleton = true
)
class FakeAccountService(context: Context) : IAccountService {
    ...
    companion object {
        ...
        @RouterProvider
        @JvmStatic
        fun getInstance(): FakeAccountService {
            return FakeAccountService(Router.getService(Context::class.java, APPLICATION))
        }
    }
